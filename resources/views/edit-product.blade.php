      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('products.update',$product->id)}}" method="post" enctype="multipart/form-data" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="" class="form-control py-2" name="productTitle" value="{{old('productTitle',$product->productTitle)}}"/>
              @error('productTitle')
          ...
          <hr>
          <div class="form-group mb-3 row">
           <label class="form-label col-md-2" for="image">Image:</label>
           <div class="col-md-10">
