                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="{{asset('assets/images/'.$products->image)}}" class="img-fluid product-image" alt="">
                                </a>
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="product-detail.html" class="product-title-link">{{$products['productTitle']}}</a>
                                        </h5>

                                        <p class="product-p">{{$products['description']}}</p>
                                    </div>

                                    <small class="product-price text-muted ms-auto mt-auto mb-5">${{$products['price']}}</small>
                                </div>
                            </div>
                        </div>
                        @endforeach
