      ...
      <a href="{{ LaravelLocalization::getLocalizedURL('ar') }}">Arabic</a>
        ...
        <form action="{{route('cars.store')}}" method="post" enctype="multipart/form-data" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="" class="form-control py-2" name="carTitle" value="{{old('carTitle')}}"/>
              @error('carTitle')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" step="0.1" placeholder="" class="form-control py-2" name="price" value="{{old('price')}}"/>
              @error('price')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <hr>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">{{ __('cars.publish') }}:</label>
            <div class="col-md-10">
